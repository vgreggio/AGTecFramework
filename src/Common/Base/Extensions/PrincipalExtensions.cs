...
namespace AGTec.Common.Base.Extensions
{
    public static class PrincipalExtensions
    {
        public static string GetUsernameFromClaim(this IPrincipal principal)
        {
            ...
            {
                var usernameClaim = claimsPrincipal.Identities.FirstOrDefault()?.Claims.FirstOrDefault(c => c.Type == "preferred_username");
                var clientIdClaim = claimsPrincipal.Identities.FirstOrDefault()?.Claims.FirstOrDefault(c => c.Type == "client_id");
