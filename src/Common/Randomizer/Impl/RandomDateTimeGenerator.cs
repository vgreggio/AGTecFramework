...
public class RandomDateTimeGenerator : RandomGenericGeneratorBase<DateTime>, IRandomDateTime
{
    ...
    private DateTime RandomMonths(DateTime min, DateTime max)
    {
        ...
        var randomValue = new DateTime(randomYear, randomMonth, randomDay, randomHour, randomMinute, randomSecond,
            randomMillisecond);
        ...
        if (randomValue < min)
        {
            ...
            randomValue = new DateTime(randomYear, randomMonth, randomDay, randomHour, randomMinute, randomSecond,
                randomMillisecond);
        }
